...
{
   [Migration(nameof(Migration_202306292030_CreateClimatixs))]
   internal sealed class Migration_202306292030_CreateClimatixs : MigrationBase
   {
      protected override void Up(MigrationBuilder migrationBuilder)
      {
         migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
               Date = table.Column<DateTime>(name: nameof(Climatix.Date), precision: 0),
            ...
            constraints: table =>
            {
               ...
               table.ForeignKey($"FK_{nameof(Climatix)}_{nameof(Climatix.Device)}", x => x.DeviceId, principalTable: nameof(Device), principalColumn: nameof(Device.Id));
            }
         );
      }
