   ...
   internal static class DeviceMappings
   {
      ...
      public static DeviceDto ToDeviceDto(this Device device)
      {
         return new()
         {
            ...
            ReportSequence = device.ReportSequence,
      ...
      public static DeviceHistoryDto ToDeviceHistoryDto(this DeviceHistory deviceHistory)
      {
         return new()
         {
            ...
            DeviceType = deviceHistory.DeviceType?.GetDescription() ?? string.Empty,
            ...
            ReportSequence = deviceHistory.ReportSequence.ToString() ?? string.Empty,
