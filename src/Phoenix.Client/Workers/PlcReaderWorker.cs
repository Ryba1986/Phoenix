...
{
   internal sealed class PlcReaderWorker : WorkerBase
   {
      private readonly IIndex<PlcType, IPlcProcessor> _plcProcessors;

      public PlcReaderWorker(IMediator mediator, PhoenixSettings settings, IIndex<PlcType, IPlcProcessor> plcProcessors) : base(mediator, settings)
      {
