...
export const en: Language = {
   components: {
      ...
      rvd145: {
         ...
         ch1HighOutletTemp: "Heating - high inlet temp",
         ch1LowInletTemp: "Heating - low inlet temp",
         ch1LowOutletPresure: "Heating - low outlet presure",
         chHighInletPresure: "Network - high inlet presure",
