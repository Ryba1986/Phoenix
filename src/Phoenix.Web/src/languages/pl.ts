...
export const pl: Language = {
   components: {
      climatix: {
         ...
         ch2Short: "CO2",
         dhwShort: "CWU",
         ch1HeatCurveTemp: "Ogrzewanie 1 - krzywa grzania temp",
         ch1LowInletTemp: "Ogrzewanie 1 - wyjście zasilanie temp",
         ch1LowOutletTemp: "Ogrzewanie 1 - wyjście powrót temp",
         ch1LowOutletPresure: "Ogrzewanie 1 - wyjście powrót ciśnienie",
         ch2HeatCurveTemp: "Ogrzewanie 2 - krzywa grzania temp",
         ch2LowInletTemp: "Ogrzewanie 2 - wyjście zasilanie temp",
         ch2LowOutletTemp: "Ogrzewanie 2 - wyjście powrót temp",
         ch2LowOutletPresure: "Ogrzewanie 2 - wyjście powrót ciśnienie",
      ...
      rvd145: {
         ...
         chShort: "CO",
         dhwShort: "CWU",
         ch1HeatCurveTemp: "Ogrzewanie - zadana temp",
         ch1HighOutletTemp: "Ogrzewanie - wejście powrót temp",
         ch1LowInletTemp: "Ogrzewanie - wyjście zasilanie temp",
         ch1LowOutletPresure: "Ogrzewanie - wyjście powrót ciśnienie",
         chHighInletPresure: "Sieć - wejście zasilanie ciśnienie",
         dhwCirculationTemp: "Ciepła woda - cyrkulacja temp",
         dhwTemp: "Ciepła woda - temp",
         dhwTempSet: "Ciepła woda - zadana temp",
         network: "Sieć",
         outsideTemp: "Temp zewnętrzna",
