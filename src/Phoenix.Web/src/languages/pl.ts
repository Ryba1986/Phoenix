...
export const pl: Language = {
   components: {
      ...
      rvd145: {
         ...
         ch1HighOutletTemp: "Ogrzewanie - wejście zasilanie temp",
         ch1LowInletTemp: "Ogrzewanie - temp",
         ch1LowOutletPresure: "Ogrzewanie - ciśnienie",
         chHighInletPresure: "Sieć - ciśnienie",
