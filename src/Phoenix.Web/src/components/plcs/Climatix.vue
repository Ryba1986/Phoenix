...
const props = defineProps({
   plc: {
      type: Object as PropType<ClimatixDto>,
      default: {},
      required: true,
   },
});
...
<template>
   <Card>
      ...
      <template #body>
         ...
         <table class="table table-sm table-borderless table-striped d-lg-none">
            <tbody>
               <tr>
                  ...
                  <td class="text-end">{{ props.plc.outsideTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.chHighInletPresure") }}</td>
                  <td class="text-end">{{ props.plc.chHighInletPresure.toFixed(1) }}</td>
                  <td class="text-muted">bar</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.chHighOutletPresure") }}</td>
                  <td class="text-end">{{ props.plc.chHighOutletPresure.toFixed(1) }}</td>
                  <td class="text-muted">bar</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.ch1HeatCurveTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch1HeatCurveTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.ch1LowInletTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch1LowInletTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.ch1LowOutletTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch1LowOutletTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr>
                  <td class="text-muted">{{ t("components.climatix.ch1LowOutletPresure") }}</td>
                  <td class="text-end">{{ props.plc.ch1LowOutletPresure.toFixed(1) }}</td>
                  <td class="text-muted">bar</td>
               </tr>
               <tr v-if="isDoubleHeatingPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.ch2HeatCurveTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch2HeatCurveTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr v-if="isDoubleHeatingPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.ch2LowInletTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch2LowInletTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr v-if="isDoubleHeatingPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.ch2LowOutletTemp") }}</td>
                  <td class="text-end">{{ props.plc.ch2LowOutletTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr v-if="isDoubleHeatingPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.ch2LowOutletPresure") }}</td>
                  <td class="text-end">{{ props.plc.ch2LowOutletPresure.toFixed(1) }}</td>
                  <td class="text-muted">bar</td>
               </tr>
               <tr v-if="isDomesticPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.dhwTempSet") }}</td>
                  <td class="text-end">{{ props.plc.dhwTempSet.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
               <tr v-if="isDomesticPlcType(props.plc)">
                  <td class="text-muted">{{ t("components.climatix.dhwTemp") }}</td>
                  <td class="text-end">{{ props.plc.dhwTemp.toFixed(1) }}</td>
                  <td class="text-muted">&#8451;</td>
               </tr>
            </tbody>
         </table>
         ...
         <!-- prettier-ignore -->
         <svg
            v-if="isHeatingPlcType(props.plc)"
         ...
         >
            <defs id="defs2">
               ...
               <linearGradient id="linearGradient1584" x1="221" x2="196" y1="151" y2="97.7" gradientTransform="matrix(.98 0 0 .835 54.2 -57)" gradientUnits="userSpaceOnUse">
            ...
            <g id="layer1" transform="translate(-16.6 -4.25)">
               <text id="text4258-4-5-8-7-0" x="200.04912" y="42.26754" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan2261-8" x="200.04912" y="42.26754">{{ props.plc.ch1ValvePosition.toFixed(1) }} %</tspan></text>
               <text id="text4258-6" x="297.72708" y="46.519512" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve">          <tspan id="tspan1142" x="297.72708" y="46.519512">{{ props.plc.ch1LowOutletPresure.toFixed(1) }} bar</tspan></text>
               ...
               <text id="text4258-4-5" x="297.59531" y="19.889423" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1140" x="297.59531" y="19.889423">{{ props.plc.ch1LowInletTemp.toFixed(1) }} °C</tspan></text>
               ...
               <text id="text4258-4-5-2" x="328.36539" y="46.8834" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1140-0" x="328.36539" y="46.8834">{{ props.plc.ch1LowOutletTemp.toFixed(1) }} °C</tspan></text>
               <text id="text4258-4-5-9" x="297.59531" y="11.716424" style="fill:#ff0000;font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1143" x="297.59531" y="11.716424">{{ props.plc.ch1HeatCurveTemp.toFixed(1) }} °C</tspan></text>
               ...
               <g id="CoPumpStatus" transform="translate(172 13.4)">
                  <ellipse id="path2202-9" cx="219" cy="18.7" rx="5.85" ry="5.85" :fill="getPumpStatus(props.plc.ch1PumpAlarm, props.plc.ch1PumpStatus)" style="stroke-width:.3;stroke:#000"/>
               ...
               <text id="text1539-1-4" x="258.54254" y="48.733189" style="font-family:sans-serif;font-size:7.06px;line-height:1.25;stroke-width:.265" xml:space="preserve"><tspan id="tspan1537-8-7" x="258.54254" y="48.733189" style="fill:#ffffff;font-family:sans-serif;font-size:7.06px;font-weight:bold;stroke-width:.265;text-align:center;text-anchor:middle" :visibility="getSectionStatus(props.plc.ch1Status)">{{ t('components.climatix.ch1Short') }}</tspan></text>
               <text id="text4258-6-9" x="115.39965" y="20.126001" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan315" x="115.39965" y="20.126001">{{ props.plc.chHighInletPresure.toFixed(1) }} bar</tspan></text>
               <text id="text4258-6-9-5" x="115.11905" y="47.033669" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan315-2" x="115.11905" y="47.033669">{{ props.plc.chHighOutletPresure.toFixed(1) }} bar</tspan></text>
               <g id="g579">
                  <text id="text4258-4-5-87-6" transform="translate(-74.5 64.9)" x="568.32159" y="-47.113564" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;inline-size:133.935;line-height:1.25;stroke-width:.265;text-align:end;text-anchor:end;white-space:pre" xml:space="preserve"><tspan id="tspan1" x="568.32159" y="-47.113564">{{ props.plc.outsideTemp.toFixed(1) }} °C</tspan></text>
         ...
         <!-- prettier-ignore -->
         <svg
            v-if="isDoubleHeatingPlcType(props.plc)"
            class="d-none d-lg-block"
            version="1.1"
            viewBox="0 0 501 122"
            xmlns="http://www.w3.org/2000/svg"
         ...
         >
            ...
            <g id="layer1" transform="translate(-16.6 -4.25)">
               <text id="text4258-4-5-8-7" x="199.94214" y="94.78157" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan2261" x="199.94214" y="94.78157">{{ props.plc.ch2ValvePosition.toFixed(1) }} %</tspan></text>
               <text id="text4258-4-5-8-7-0" x="200.04912" y="42.26754" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan2261-8" x="200.04912" y="42.26754">{{ props.plc.ch1ValvePosition.toFixed(1) }} %</tspan></text>
               <text id="text4258-4-5-8" x="297.73947" y="74.870934" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan4">{{ props.plc.ch2LowInletTemp.toFixed(1) }} °C</tspan></text>
               <text id="text4258-4-5-9-7" x="297.73947" y="67.756256" style="fill:#ff0000;font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1">{{ props.plc.ch2HeatCurveTemp.toFixed(1) }} °C</tspan></text>
               <text id="text4258-6" x="297.72708" y="46.519512" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve">          <tspan id="tspan1142" x="297.72708" y="46.519512">{{ props.plc.ch1LowOutletPresure.toFixed(1) }} bar</tspan></text>
               <text id="text4258-6-1" x="328.65228" y="101.80676" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve">          <tspan id="tspan1142-0" x="328.65228" y="101.80676">{{ props.plc.ch2LowOutletPresure.toFixed(1) }} bar</tspan></text>
               <g id="g1900" transform="translate(-.15 3.18)">
                  <g id="g3632-6" transform="matrix(1.12 0 0 1.12 249 -60.9)" style="stroke-width:.889">
                     <g id="g895-2" transform="matrix(.00977 0 0 .00977 41.2 72.3)" style="stroke-width:24.1">
                        <g id="g6-5" style="stroke-width:24.1">
               ...
               <path id="path2-71-2" d="m505 57v3.52l8.2-3.52v3.52z" fill="none" stroke="#000" style="fill:#fff;stroke-width:.298"/>
               <text id="text3139-5" x="513.12549" y="47.578751" style="font-family:sans-serif;font-size:5.64px;line-height:1.25;stroke-width:.265" xml:space="preserve"><tspan id="tspan317" x="513.12549" y="47.578751" style="font-family:sans-serif;font-size:5.64px;stroke-width:.265;text-align:end;text-anchor:end">{{ t('components.climatix.ch') }}</tspan></text>
               <g id="g1900-2" transform="translate(.00467 58.1)">
                  <g id="g3632-6-9" transform="matrix(1.12 0 0 1.12 249 -60.9)" style="stroke-width:.889">
                     <g id="g895-2-7" transform="matrix(.00977 0 0 .00977 41.2 72.3)" style="stroke-width:24.1">
                        <g id="g6-5-2" style="stroke-width:24.1">
                           <g id="g4-3-6" style="stroke-width:24.1">
                              <path id="path2-2-9-6" d="m276 318v-167h-39.4v167c-22.9 8.13-39.4 30-39.4 55.7 0 32.6 26.5 59.1 59.1 59.1s59.1-26.5 59.1-59.1c.001-25.7-16.5-47.6-39.4-55.7zm-19.7 75.4c-10.9 0-19.7-8.83-19.7-19.7s8.83-19.7 19.7-19.7 19.7 8.83 19.7 19.7-8.83 19.7-19.7 19.7z" style="stroke-width:24.1"/>
                           </g>
                        </g>
                        <g id="g12-5-36" style="stroke-width:24.1">
                           <g id="g10-0-2" style="stroke-width:24.1">
                              <path id="path8-7-3" d="m354 278v-179c0-54.3-44.2-98.5-98.5-98.5s-98.5 44.2-98.5 98.5v179c-25.1 25.7-39.4 60.3-39.4 96.5.001 76 61.8 138 138 138s138-61.8 138-138c0-36.1-14.3-70.8-39.4-96.5zm-98.5 195c-54.3 0-98.5-44.2-98.5-98.5 0-28 12-54.7 32.8-73.4l6.56-5.87v-196c0-32.6 26.5-59.1 59.1-59.1s59.1 26.5 59.1 59.1v196l6.56 5.87c20.9 18.7 32.8 45.4 32.8 73.4 0 54.3-44.2 98.5-98.5 98.5z" style="stroke-width:24.1"/>
                           </g>
                        </g>
                     </g>
                     <path id="path6-8-1-2-3" d="m43.7 71.3c-1.93 0-3.5 1.57-3.5 3.5 0 1.59 1.06 2.93 2.51 3.36v.912c0 .129.105.234.234.234h1.51c.129 0 .234-.105.234-.234v-.912c1.45-.427 2.51-1.77 2.51-3.36-1.6e-5-1.93-1.57-3.5-3.5-3.5zm.519 7.53h-1.04v-.574c.343.051.695.051 1.04 0zm-.519-1c-1.67 0-3.03-1.36-3.03-3.03 0-1.67 1.36-3.03 3.03-3.03s3.03 1.36 3.03 3.03c0 1.67-1.36 3.03-3.03 3.03z" style="stroke-width:.235"/>
                  </g>
               </g>
               <g id="g1900-1-2" transform="translate(30.8 85.1)">
                  <g id="g3632-6-5-2" transform="matrix(1.12 0 0 1.12 249 -60.9)" style="stroke-width:.889">
                     <g id="g895-2-4-8" transform="matrix(.00977 0 0 .00977 41.2 72.3)" style="stroke-width:24.1">
                        <g id="g6-5-5-9" style="stroke-width:24.1">
                           <g id="g4-3-5-9" style="stroke-width:24.1">
                              <path id="path2-2-9-5-4" d="m276 318v-167h-39.4v167c-22.9 8.13-39.4 30-39.4 55.7 0 32.6 26.5 59.1 59.1 59.1s59.1-26.5 59.1-59.1c.001-25.7-16.5-47.6-39.4-55.7zm-19.7 75.4c-10.9 0-19.7-8.83-19.7-19.7s8.83-19.7 19.7-19.7 19.7 8.83 19.7 19.7-8.83 19.7-19.7 19.7z" style="stroke-width:24.1"/>
                           </g>
                        </g>
                        <g id="g12-5-3-0" style="stroke-width:24.1">
                           <g id="g10-0-9-0" style="stroke-width:24.1">
                              <path id="path8-7-1-8" d="m354 278v-179c0-54.3-44.2-98.5-98.5-98.5s-98.5 44.2-98.5 98.5v179c-25.1 25.7-39.4 60.3-39.4 96.5.001 76 61.8 138 138 138s138-61.8 138-138c0-36.1-14.3-70.8-39.4-96.5zm-98.5 195c-54.3 0-98.5-44.2-98.5-98.5 0-28 12-54.7 32.8-73.4l6.56-5.87v-196c0-32.6 26.5-59.1 59.1-59.1s59.1 26.5 59.1 59.1v196l6.56 5.87c20.9 18.7 32.8 45.4 32.8 73.4 0 54.3-44.2 98.5-98.5 98.5z" style="stroke-width:24.1"/>
                           </g>
                        </g>
                     </g>
                     <path id="path6-8-1-2-5-5" d="m43.7 71.3c-1.93 0-3.5 1.57-3.5 3.5 0 1.59 1.06 2.93 2.51 3.36v.912c0 .129.105.234.234.234h1.51c.129 0 .234-.105.234-.234v-.912c1.45-.427 2.51-1.77 2.51-3.36-1.6e-5-1.93-1.57-3.5-3.5-3.5zm.519 7.53h-1.04v-.574c.343.051.695.051 1.04 0zm-.519-1c-1.67 0-3.03-1.36-3.03-3.03 0-1.67 1.36-3.03 3.03-3.03s3.03 1.36 3.03 3.03c0 1.67-1.36 3.03-3.03 3.03z" style="stroke-width:.235"/>
                  </g>
               </g>
               <text id="text4258-4-5-2-5" x="297.73947" y="101.80676" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan5">{{ props.plc.ch2LowOutletTemp.toFixed(1) }} °C</tspan></text>
               <g id="g3272-3-1-4-85" transform="matrix(1.01 0 0 1.01 348 68.3)" style="stroke-width:.989">
                  <path id="path6703-4-0-2-0-7" d="m17.5 17.7v-3.02" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path6705-4-8-8-9-6" d="m17.5 14.7a2.38 2.42 0 01-2.38-2.42 2.38 2.42 0 012.38-2.42 2.38 2.42 0 012.38 2.42 2.38 2.42 0 01-2.38 2.42" style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279;stroke:#000"/>
                  <path id="path7580-1-9-7-5" d="m16.2 11.1 2.38 2.42" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path7582-5-7-3-59" d="m16.2 11.1.626 1.11.453-.451z" style="fill-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279px;stroke:#000"/>
               </g>
               <g id="g3272-3-1-4-6-4" transform="matrix(1.01 0 0 1.01 401 68.3)" style="stroke-width:.989">
                  <path id="path6703-4-0-2-0-8-3" d="m17.5 17.7v-3.02" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path6705-4-8-8-9-2-9" d="m17.5 14.7a2.38 2.42 0 01-2.38-2.42 2.38 2.42 0 012.38-2.42 2.38 2.42 0 012.38 2.42 2.38 2.42 0 01-2.38 2.42" style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279;stroke:#000"/>
                  <path id="path7580-1-9-7-4-6" d="m16.2 11.1 2.38 2.42" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path7582-5-7-3-5-3" d="m16.2 11.1.626 1.11.453-.451z" style="fill-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279px;stroke:#000"/>
               </g>
               <g id="g837-4-6" transform="matrix(.17 0 0 .171 468 77.8)" style="stroke-width:1.66">
                  <path id="path6703-5-3" d="m17.7 49.6v-17.7" style="fill:none;stroke-width:1.66px;stroke:#000"/>
                  <path id="path6705-1-99" transform="translate(-138 10.6)" d="m156 21.3a14.2 14.2 0 01-14.2-14.2 14.2 14.2 0 0114.2-14.2 14.2 14.2 0 0114.2 14.2 14.2 14.2 0 01-14.2 14.2" style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.66;stroke:#000"/>
                  <path id="path8463-7-7" d="m17.7 24.8v-17.7" style="fill:none;stroke-width:1.66px;stroke:#000"/>
                  <path id="path8465-0-1" transform="matrix(1.5 0 0 1.5 -6.2 -9.74)" d="m15.9 24.8a1.77 1.77 0 01-1.77-1.77 1.77 1.77 0 011.77-1.77 1.77 1.77 0 011.77 1.77 1.77 1.77 0 01-1.77 1.77"/>
               </g>
               <rect id="rect2941-51-1" x="270" y="85.8" width="236" height="2" style="fill:#c80000;stroke-width:.368"/>
               <g id="g837-4-3-8" transform="matrix(.17 0 0 .171 468 104)" style="stroke-width:1.66">
                  <path id="path6703-5-0-3" d="m17.7 49.6v-17.7" style="fill:none;stroke-width:1.66px;stroke:#000"/>
                  <path id="path6705-1-9-5" transform="translate(-138 10.6)" d="m156 21.3a14.2 14.2 0 01-14.2-14.2 14.2 14.2 0 0114.2-14.2 14.2 14.2 0 0114.2 14.2 14.2 14.2 0 01-14.2 14.2" style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.66;stroke:#000"/>
                  <path id="path8463-7-6-9" d="m17.7 24.8v-17.7" style="fill:none;stroke-width:1.66px;stroke:#000"/>
                  <path id="path8465-0-9-6" transform="matrix(1.5 0 0 1.5 -6.2 -9.74)" d="m15.9 24.8a1.77 1.77 0 01-1.77-1.77 1.77 1.77 0 011.77-1.77 1.77 1.77 0 011.77 1.77 1.77 1.77 0 01-1.77 1.77"/>
               </g>
               <g id="g3272-3-1-4-8-0" transform="matrix(1.01 0 0 1.01 348 94.9)" style="stroke-width:.989">
                  <path id="path6703-4-0-2-0-2-3" d="m17.5 17.7v-3.02" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path6705-4-8-8-9-7-3" d="m17.5 14.7a2.38 2.42 0 01-2.38-2.42 2.38 2.42 0 012.38-2.42 2.38 2.42 0 012.38 2.42 2.38 2.42 0 01-2.38 2.42" style="fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279;stroke:#000"/>
                  <path id="path7580-1-9-7-6-3" d="m16.2 11.1 2.38 2.42" style="fill:none;stroke-width:.279px;stroke:#000"/>
                  <path id="path7582-5-7-3-9-8" d="m16.2 11.1.626 1.11.453-.451z" style="fill-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-width:.279px;stroke:#000"/>
               </g>
               <g id="g4218-8" transform="matrix(1.5 0 0 1.49 310 -12)" style="stroke-width:.779">
                  <rect id="rect4199-3" x="69.1" y="74.5" width="5.35" height="8.2" ry="1.56" style="fill:none;paint-order:markers stroke fill;stroke-linejoin:round;stroke-width:.362;stroke:#000"/>
                  <path id="path4201-5" d="m69.1 78.6 5.31-.1" style="fill:none;stroke-width:.284;stroke:#000"/>
                  <rect id="rect4205-9" x="71.2" y="82.8" width="1.17" height=".797" ry="0" style="fill:none;paint-order:markers stroke fill;stroke-linejoin:round;stroke-width:.206;stroke:#000"/>
               </g>
               <rect id="rect2941-5-6-7" x="270" y="113" width="236" height="2" style="fill:#1300e3;stroke-width:.368"/>
               <g id="g8-6-9-2" transform="matrix(.0176 0 0 .0176 293 104)" style="stroke-width:15.1">
                  <path id="path2-1-7-9-6" d="m256 64.3c-88 0-160 71.6-160 160s71.6 160 160 160 160-71.6 160-160-71.6-160-160-160zm102 240-5.76-5.76c-5.86-5.86-15.4-5.86-21.2-.005-5.86 5.86-5.86 15.4-.005 21.2l5.76 5.77c-22.1 17.5-50 28-80.4 28s-58.3-10.5-80.4-28l5.76-5.77c5.86-5.86 5.85-15.4-.005-21.2s-15.4-5.85-21.2.005l-5.76 5.76c-14.6-18.4-24.3-40.9-27.1-65.4h8.23c8.28 0 15-6.72 15-15s-6.72-15-15-15h-8.23c2.84-24.5 12.5-47 27.1-65.4l5.76 5.76c5.86 5.86 15.4 5.86 21.2.005 5.86-5.86 5.86-15.4.005-21.2l-5.76-5.77c18.4-14.6 40.9-24.3 65.4-27.1v8.23c0 8.28 6.72 15 15 15s15-6.72 15-15v-8.23c24.5 2.84 47 12.5 65.4 27.1l-5.76 5.77c-5.86 5.86-5.85 15.4.005 21.2 5.86 5.86 15.4 5.85 21.2-.005l5.76-5.76c14.6 18.4 24.3 40.9 27.1 65.4h-8.23c-8.28 0-15 6.72-15 15s6.72 15 15 15h8.23c-2.84 24.5-12.5 47-27.1 65.4z" style="stroke-width:15.1"/>
                  <path id="path4-9-3-5" d="m261 197-56.2 56.2c-5.86 5.86-5.86 15.4 0 21.2 5.86 5.86 15.4 5.86 21.2 0l56.2-56.2c5.86-5.86 5.86-15.4 0-21.2-5.86-5.86-15.4-5.86-21.2 0z" style="stroke-width:15.1"/>
                  <path id="path6-8-9-3" d="m256 0c-123 0-224 100-224 224 0 102 67.9 187 161 215v58.4c0 8.28 6.72 15 15 15h96.4c8.28 0 15-6.72 15-15v-58.4c92.8-27.3 161-113 161-215-.001-123-100-224-224-224zm33.2 482h-66.4v-36.7c21.9 3.27 44.5 3.27 66.4 0zm-33.2-64.3c-107 0-194-87-194-194s87-194 194-194 194 87 194 194-87 194-194 194z" style="stroke-width:15.1"/>
               </g>
               <g id="CoPumpStatus-3" transform="translate(172 68.3)">
                  <ellipse id="path2202-9-6" cx="219" cy="18.7" rx="5.85" ry="5.85" :fill="getPumpStatus(props.plc.ch2PumpAlarm, props.plc.ch2PumpStatus)" style="stroke-width:.3;stroke:#000"/>
                  <path id="path2789-3-3" d="m217 24.1 7.92-4.09" style="fill:none;stroke-width:.3;stroke:#000"/>
                  <path id="path2791-7-1" d="m217 13.2 7.92 4.09" style="fill-rule:evenodd;stroke-width:.3;stroke:#000"/>
               </g>
               <path id="path2-71-5" d="m506 85v3.52l8.2-3.52v3.52z" fill="none" stroke="#000" style="fill:#fff;stroke-width:.298"/>
               <path id="path2-71-2-9" d="m506 112v3.52l8.2-3.52v3.52z" fill="none" stroke="#000" style="fill:#fff;stroke-width:.298"/>
               <text id="text3139-5-7" x="513.28058" y="102.50212" style="font-family:sans-serif;font-size:5.64px;line-height:1.25;stroke-width:.265" xml:space="preserve"><tspan id="tspan317-8" x="513.28058" y="102.50212" style="font-family:sans-serif;font-size:5.64px;stroke-width:.265;text-align:end;text-anchor:end">{{ t('components.climatix.ch') }}</tspan></text>
               <g id="g4432" transform="matrix(1.33 0 0 1.33 104 -80.3)" style="stroke-width:.753">
                  <rect id="rect4426" x="66.6" y="102" width="11.2" height="5.65" style="fill:#fff;paint-order:markers stroke fill"/>
                  <path id="path2-3" d="m66.6 102v5.58l11.1-5.58v5.58z" fill="none" stroke="#000" style="fill:#ffa400;stroke-width:.199"/>
                  <path id="path4412" d="m72.1 105c0-4.78-.0668-4.86-.0668-4.86" style="fill:none;stroke-width:.199px;stroke:#000"/>
               ...
               <text id="text1539-1" x="258.01889" y="103.85229" style="font-family:sans-serif;font-size:7.06px;line-height:1.25;stroke-width:.265" xml:space="preserve"><tspan id="tspan1537-8" x="258.01889" y="103.85229" style="fill:#ffffff;font-family:sans-serif;font-size:7.06px;font-weight:bold;stroke-width:.265;text-align:center;text-anchor:middle" :visibility="getSectionStatus(props.plc.ch2Status)">{{ t('components.climatix.ch2Short') }}</tspan></text>
               <rect id="rect654-1" x="246" y="24.5" width="25.3" height="44.5" ry="4.31" style="fill:url(#linearGradient1584);stroke-width:.266"/>
               <text id="text1539-1-4" x="258.54254" y="48.733189" style="font-family:sans-serif;font-size:7.06px;line-height:1.25;stroke-width:.265" xml:space="preserve"><tspan id="tspan1537-8-7" x="258.54254" y="48.733189" style="fill:#ffffff;font-family:sans-serif;font-size:7.06px;font-weight:bold;stroke-width:.265;text-align:center;text-anchor:middle" :visibility="getSectionStatus(props.plc.ch1Status)">{{ t('components.climatix.ch1Short') }}</tspan></text>
               <text id="text4258-6-9" x="115.39965" y="20.126001" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan315" x="115.39965" y="20.126001">{{ props.plc.chHighInletPresure.toFixed(1) }} bar</tspan></text>
               <text id="text4258-6-9-5" x="115.11905" y="47.033669" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan315-2" x="115.11905" y="47.033669">{{ props.plc.chHighOutletPresure.toFixed(1) }} bar</tspan></text>
               <g id="g579">
                  <text id="text4258-4-5-87-6" transform="translate(-74.5 64.9)" x="568.32159" y="-47.113564" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;inline-size:133.935;line-height:1.25;stroke-width:.265;text-align:end;text-anchor:end;white-space:pre" xml:space="preserve"><tspan id="tspan2" x="568.32159" y="-47.113564">{{ props.plc.outsideTemp.toFixed(1) }} °C</tspan></text>
                  <path id="path7" d="m509 19.8c0 .355-.288.643-.643.643-.355 0-.643-.288-.643-.643 0-.355.288-.643.643-.643.355 0 .643.288.643.643zm2.38-3.6h1.58v-1.29h-1.58zm0-3.54v1.29h1.58v-1.29zm0 5.79h1.58v-1.29h-1.58zm-.965-.731c.548.559.868 1.32.868 2.08 0 1.63-1.33 2.96-2.96 2.96s-2.96-1.33-2.96-2.96c0-.764.319-1.52.866-2.08l.002-3.93c0-1.15.938-2.09 2.09-2.09 1.15 0 2.09.938 2.09 2.09zm-.418 2.08c0-.489-.237-.977-.635-1.3l-.234-.193v-4.52c0-.443-.361-.804-.804-.804-.443 0-.804.361-.804.804l-.002 4.52-.233.193c-.396.328-.633.815-.633 1.3 0 .922.75 1.67 1.67 1.67.922 0 1.67-.75 1.67-1.67zm-5.95 1.67h-4.02c-.355 0-.643-.289-.643-.643v-7.93l5.34-4.87 2.61 2.38h1.91l-4.51-4.12-8.24 7.52.867.95.749-.683v6.75c0 1.06.865 1.93 1.93 1.93h5.26c-.36-.37-.653-.805-.86-1.29z" fill="url(#a)" style="fill:url(#linearGradient328);stroke-width:.0549"/>
               </g>
            </g>
         </svg>
         ...
         <!-- prettier-ignore -->
         <svg
            v-if="isDomesticPlcType(props.plc)"
            class="d-none d-lg-block"
            version="1.1"
            viewBox="0 0 501 138"
            xmlns="http://www.w3.org/2000/svg"
         ...
         >
            ...
            <g id="layer1" transform="translate(-16.6 -4.25)">
               <text id="text4258-4-5-8-7" x="199.94214" y="94.78157" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan2261">{{ props.plc.dhwValvePosition.toFixed(1) }} %</tspan></text>
               <text id="text4258-4-5-8-7-0" x="200.04912" y="42.26754" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan2261-8" x="200.04912" y="42.26754">{{ props.plc.ch1ValvePosition.toFixed(1) }} %</tspan></text>
               ...
               <text id="text4258-4-5-8" x="297.73947" y="74.870934" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1139" x="297.73947" y="74.870934">{{ props.plc.dhwTemp.toFixed(1) }} °C</tspan></text>
               <text id="text4258-4-5-9-7" x="297.73947" y="67.756256" style="fill:#ff0000;font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve"><tspan id="tspan1141" x="297.73947" y="67.756256">{{ props.plc.dhwTempSet.toFixed(1) }} °C</tspan></text>
               <text id="text4258-6" x="297.72708" y="46.519512" style="font-family:sans-serif;font-size:6.35px;font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal;line-height:1.25;stroke-width:.265;text-align:center;text-anchor:middle" xml:space="preserve">          <tspan id="tspan1142" x="297.72708" y="46.519512">{{ props.plc.ch1LowOutletPresure.toFixed(1) }} bar</tspan></text>
               <g id="g1900" transform="translate(-.15 3.18)">
                  <g id="g3632-6" transform="matrix(1.12 0 0 1.12 249 -60.9)" style="stroke-width:.889">
                     <g id="g895-2" transform="matrix(.00977 0 0 .00977 41.2 72.3)" style="stroke-width:24.1">
               ...
               <g id="DhwPumpStatus" transform="matrix(-1 0 0 1 609 116)" :fill="getPumpStatus(props.plc.dhwPumpAlarm, props.plc.dhwPumpStatus)">
